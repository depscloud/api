...
_ENCODING = _descriptor.EnumDescriptor(
  name='Encoding',
  full_name='graphstore.api.v1beta.Encoding',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='PROTOCOL_BUFFERS', index=2, number=2,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_GRAPHITEM = _descriptor.Descriptor(
  name='GraphItem',
  full_name='graphstore.api.v1beta.GraphItem',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='encoding', full_name='graphstore.api.v1beta.GraphItem.encoding', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='data', full_name='graphstore.api.v1beta.GraphItem.data', index=5,
...
GraphItem = _reflection.GeneratedProtocolMessageType('GraphItem', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:graphstore.api.v1beta.GraphItem)
  })
