...
# source: grpc-gateway/third_party/googleapis/google/api/http.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='grpc-gateway/third_party/googleapis/google/api/http.proto',
  package='google.api',
  syntax='proto3',
...
Http = _reflection.GeneratedProtocolMessageType('Http', (_message.Message,), {
  'DESCRIPTOR' : _HTTP,
  '__module__' : 'grpc_gateway.third_party.googleapis.google.api.http_pb2'
