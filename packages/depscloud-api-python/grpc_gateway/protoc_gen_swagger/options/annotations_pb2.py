...
# source: grpc-gateway/protoc-gen-swagger/options/annotations.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='grpc-gateway/protoc-gen-swagger/options/annotations.proto',
