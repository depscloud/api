...
// swagger/v1alpha/tracker/tracker.swagger.json
// swagger/v1alpha/extractor/extractor.swagger.json
// swagger/v1alpha/schema/schema.swagger.json
// swagger/v1alpha/deps/deps.swagger.json
// swagger/v1alpha/store/store.swagger.json
package swagger
...
var _bindata = map[string]func() (*asset, error){
	"swagger/v1alpha/tracker/tracker.swagger.json":     swaggerV1alphaTrackerTrackerSwaggerJson,
	"swagger/v1alpha/extractor/extractor.swagger.json": swaggerV1alphaExtractorExtractorSwaggerJson,
	"swagger/v1alpha/schema/schema.swagger.json":       swaggerV1alphaSchemaSchemaSwaggerJson,
	"swagger/v1alpha/deps/deps.swagger.json":           swaggerV1alphaDepsDepsSwaggerJson,
	"swagger/v1alpha/store/store.swagger.json":         swaggerV1alphaStoreStoreSwaggerJson,
}
	...
	"swagger": &bintree{nil, map[string]*bintree{
		"v1alpha": &bintree{nil, map[string]*bintree{
			"deps": &bintree{nil, map[string]*bintree{
				"deps.swagger.json": &bintree{swaggerV1alphaDepsDepsSwaggerJson, map[string]*bintree{}},
			}},
			"extractor": &bintree{nil, map[string]*bintree{
				"extractor.swagger.json": &bintree{swaggerV1alphaExtractorExtractorSwaggerJson, map[string]*bintree{}},
			}},
			"schema": &bintree{nil, map[string]*bintree{
				"schema.swagger.json": &bintree{swaggerV1alphaSchemaSchemaSwaggerJson, map[string]*bintree{}},
			}},
			"store": &bintree{nil, map[string]*bintree{
				"store.swagger.json": &bintree{swaggerV1alphaStoreStoreSwaggerJson, map[string]*bintree{}},
			}},
			"tracker": &bintree{nil, map[string]*bintree{
				"tracker.swagger.json": &bintree{swaggerV1alphaTrackerTrackerSwaggerJson, map[string]*bintree{}},
			}},
		}},
	}},
}}
